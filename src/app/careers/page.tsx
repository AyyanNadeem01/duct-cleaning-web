  ...
  return (
    <div className="w-full">
      ...
      <section className="bg-linear-to-r from-blue-600 to-blue-800 text-white py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <h1 className="text-5xl font-bold mb-4 heading-reveal">Join Our Team</h1>
          <p className="text-xl text-blue-100">Build a rewarding career with ProDuct Clean</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-blue-50 rounded-lg p-8 border-l-4 border-blue-600 text-center">
            <p className="text-gray-700 text-lg">
              <strong>Questions about a position?</strong> Contact our HR team at{' '}
              <strong>careers@productclean.com</strong> or call <strong>(555) 123-4567</strong>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-linear-to-r from-blue-50 to-blue-100">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-lg shadow-lg p-12">
            <p className="text-gray-700 text-lg mb-6 leading-relaxed">
              We're proud to offer an internship program for students interested in learning about the
              duct cleaning and maintenance industry. Interns gain valuable hands-on experience while working
              alongside our experienced professionals.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-2xl font-bold text-blue-600 mb-4">Program Benefits</h3>
                <ul className="space-y-2 text-gray-700">
                  {['Hands-on training', 'Professional mentoring', 'Competitive stipend', 'College credit available', 'Flexible scheduling'].map((item, i) => (
            ...
            <div className="text-center pt-4 border-t-2">
              <p className="text-gray-700 mb-4">Interested in our internship program? Email us today!</p>
              <a
                href="mailto:careers@productclean.com"
                className="bg-blue-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-blue-700 transition inline-block"
              >
