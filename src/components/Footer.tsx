...
export default function Footer() {
  ...
  return (
    <footer className="bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 text-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="transform transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-linear-to-br from-blue-500 to-blue-600 p-2.5 rounded-xl shadow-lg">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <span className="text-xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">ProDuct Clean</span>
            </div>
          ...
          <div>
            <h3 className="text-lg font-bold mb-6 text-white relative pb-2">
              Quick Links
              <span className="absolute bottom-0 left-0 w-12 h-0.5 bg-linear-to-r from-blue-400 to-cyan-400 rounded-full"></span>
            </h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group hover:translate-x-2 transition-transform duration-300">
                <Phone size={18} className="text-blue-400 mt-1 shrink-0 group-hover:text-cyan-400 transition-colors duration-300" />
                <div>
                  <a href={`tel:${company?.phone}`} className="text-gray-400 group-hover:text-blue-400 transition-colors duration-300 cursor-pointer">
              ...
              <div className="flex items-start gap-3 group hover:translate-x-2 transition-transform duration-300">
                <Mail size={18} className="text-blue-400 mt-1 shrink-0 group-hover:text-cyan-400 transition-colors duration-300" />
                <div>
                  <a href={`mailto:${company?.email}`} className="text-gray-400 group-hover:text-blue-400 transition-colors duration-300 cursor-pointer">
              ...
              <div className="flex items-start gap-3 group hover:translate-x-2 transition-transform duration-300">
                <MapPin size={18} className="text-blue-400 mt-1 shrink-0 group-hover:text-cyan-400 transition-colors duration-300" />
                <div>
                  <p className="text-gray-400">{company?.city}, {company?.state}</p>
                  <p className="text-gray-600 text-xs">Service Coverage Area</p>
                </div>
              </div>
            </div>
          </div>
