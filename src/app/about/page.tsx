    ...
    <div className="w-full">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <h1 className="text-5xl font-bold mb-4 heading-reveal">About ProDuct Clean</h1>
          <p className="text-xl text-blue-100">
            Serving your community with excellence since 2009
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-4 text-lg leading-relaxed">
                ProDuct Clean was founded in 2009 with a simple mission: to help families and businesses breathe cleaner, healthier air. What started as a small local operation has grown into a trusted name in professional duct cleaning services.
              </p>
              <p className="text-gray-700 mb-4 text-lg leading-relaxed">
                Our founder, John Smith, noticed that many businesses and homeowners were unaware of the importance of regular duct cleaning. He decided to change that by providing top-quality, affordable cleaning services to his community.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                Today, we're proud to serve over 10,000 satisfied customers and continue to expand our services to meet the needs of our growing community.
              </p>
            </div>
